...
files = ['../data/evolve_a21_p10_ff2_100000000_gens_0.05.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.07.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.1.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.13.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.15.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.17.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.19.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.21.csv',
         '../data/evolve_a21_p10_ff2_100000000_gens_0.5.csv']
...
F1.tight_layout()
plt.title('Fitness function 2')
plt.savefig ('evospeed_ff2.png')
plt.show()
