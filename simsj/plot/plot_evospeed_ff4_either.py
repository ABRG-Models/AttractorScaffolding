...
a2.set_xlim([0,0.55])
a2.set_ylim([-0.00035,0])
#f2.tight_layout()
#plt.savefig ('distribution_evolutionary_slope_vs_p_' + filetag + 'ff4.png')
...
#plt.savefig ('distribution_evolutionary_mean_vs_p_' + filetag + 'ff4.png')
f1.tight_layout()
plt.savefig ('evolution' + filetag + '_ff4.png')
