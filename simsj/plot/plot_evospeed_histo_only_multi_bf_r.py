...
def doPlot (driftnodrift, plottype, ff):
    ...
    files = [#'../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_2.csv',
             #'../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_3.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_4.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_5.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_6.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_8.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_10.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_12.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_14.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_16.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_18.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_20.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_22.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_24.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_26.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_28.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_30.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_32.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_34.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_36.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_38.csv',
             '../data/r_evolveb'+filetag+'_a21_p10_'+ff+'_100000000_gens_40.csv']

    if plottype == 'loglog1':
        graphtag = driftnodrift + ', log/log (log hist bins) [reducing flipbits]'
    elif plottype == 'loglog2':
        graphtag = driftnodrift + ', log/log (linear hist bins) [reducing flipbits]'
    elif plottype == 'log':
        graphtag = driftnodrift + ', lin/log [reducing flipbits]'
    else:
        graphtag = driftnodrift + ', lin/lin [reducing flipbits]'
    ...
    f2.suptitle ('{0} [reducing flipbits]'.format(driftnodrift));
    #f2.tight_layout()
    plt.savefig ('png/evolution_histos_' + plottype + filetag + '_'+ff+'_format2_fb_r.png')

    # rect=[left bottom right top]
    f1.tight_layout(rect=[0.01,0.01,0.99,0.9])
    f1.text (0.5, 0.9, graphtag, fontsize=20)
    plt.savefig ('png/evolution_histos_' + plottype + filetag + '_'+ff+'_fb_r.png')
