...
#
# Different initial states (2 bits opposite) to show algorithm not
# reliant on initial state choice. Initial: 10000 and 01000 (8)
#
...
filetag = ''
files = ['../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.05.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.1.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.15.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.2.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.25.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.3.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.35.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.4.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.45.csv',
         '../data/evolve_ia16_ip8_a21_p10_ff4_'+maxgens+'_gens_0.5.csv']
...
f1.tight_layout()
plt.savefig ('png/paper_figD_init2bit.svg')
