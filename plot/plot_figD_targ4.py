...
#
# Different target states (only 4 bits opposite) to show algorithm not
# reliant on target choice. Targets: 10101 and 11010
#
...
filetag = ''
files = ['../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.05.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.1.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.15.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.2.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.25.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.3.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.35.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.4.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.45.csv',
         '../data/evolve_ia16_ip0_a21_p26_ff4_'+maxgens+'_gens_0.5.csv']
...
f1.tight_layout()
plt.savefig ('png/paper_figD_targ4bit.svg')
